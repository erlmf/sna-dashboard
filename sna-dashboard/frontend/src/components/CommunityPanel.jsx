...
// Harus sama persis dengan PALETTE di NetworkGraph.jsx
const PALETTE = [
...
export function CommunityPanel({ onSelectCommunity, graphType = 'combined' }) {
  ...
  const communities = (data?.data ?? []).slice(0, 10)

  return (
    <div className="h-full overflow-y-auto px-5 py-4">
      <h2 className="text-sm font-display font-bold text-text uppercase tracking-wider mb-4">
        Top {communities.length} Communities
      </h2>
